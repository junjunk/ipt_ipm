/* Shared library add-on to iptables for the IPDST target
...
static struct xtables_target IPDST_tg_reg = {
	.name		= "IPDST",
...
void _init(void)
{
	xtables_register_target(&IPDST_tg_reg);
}
